...
func TestBGPPolicyConverter(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha1",
			outputBgpPolicy: v1a2BgpPolicyInvalidLocalAsn,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha1",
			outputBgpPolicy: v1a2BgpPolicyInvalidPeerAsn,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
		...
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha2",
			outputBgpPolicy: v1a2BgpPolicyConfederation16Bit,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha1",
			outputBgpPolicy: v1a1BgpPolicyConfederation16Bit,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha2",
			outputBgpPolicy: v1a2BgpPolicyConfederationInvalidId,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha1",
			outputBgpPolicy: v1a1BgpPolicyConfederationInvalidId,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha2",
			outputBgpPolicy: v1a2BgpPolicyConfederationInvalidMember,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
		{
			...
			toVersion:       "crd.antrea.io/v1alpha1",
			outputBgpPolicy: v1a1BgpPolicyConfederationInvalidMember,
			status:          metav1.Status{Status: metav1.StatusSuccess},
		},
	}
