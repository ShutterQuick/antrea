...
func (c *Controller) syncBGPPolicy(ctx context.Context) error {
	...
	peerAsnOverrides := map[string]int64{}
...
func (c *Controller) reconcileBGPPeers(ctx context.Context, bgpPeerAsnOverrides map[string]int64, bgpPeers []v1alpha1.BGPPeer) error {
...
func (c *Controller) getPeerConfigs(bgpPeerAsnOverrides map[string]int64, peers []v1alpha1.BGPPeer) map[string]bgp.PeerConfig {
...
func validate32BitAsn(asn int64) error {
	switch value := asn; {
	case value == 0:
...
func getLocalAsnOverride(bgpPolicy *v1alpha1.BGPPolicy, localAsn *int64) error {
	...
	if err := validate32BitAsn(int64(asn)); err != nil {
		return err
	}
...
func getPeerAsnOverrides(bgpPolicy *v1alpha1.BGPPolicy, overrideMap *map[string]int64) error {
